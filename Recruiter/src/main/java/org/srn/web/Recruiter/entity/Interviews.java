...
public class Interviews implements Serializable {
	...
	public Interviews(long interview_id, long client_id, long job_id, long partner_id, long application_id, String type,
			int no_of_round, Date slot_start_dt, Date slot_end_dt, String interview_tool, String interviewer_name,
			int interviewer_mail, String interview_status, String interview_result, String creator, Date dt,
			int status) {
		super();
	...
	public String toString() {
		return "Interviews [interview_id=" + interview_id + ", client_id=" + client_id + ", job_id=" + job_id
				+ ", partner_id=" + partner_id + ", application_id=" + application_id + ", type=" + type
				+ ", no_of_round=" + no_of_round + ", slot_start_dt=" + slot_start_dt + ", slot_end_dt=" + slot_end_dt
				+ ", interview_tool=" + interview_tool + ", interviewer_name=" + interviewer_name
				+ ", interviewer_mail=" + interviewer_mail + ", interview_status=" + interview_status
